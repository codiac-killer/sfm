...
static const unsigned int bg = 232;

/* colors                      fg,  bg */
static const Cpair cdir    = { 31, bg };
static const Cpair cfile   = { 243, bg };
static const Cpair clnk    = { 96, bg };
static const Cpair cblk    = { 95, bg };
static const Cpair cchr    = { 94, bg };
static const Cpair cifo    = { 93, bg };
static const Cpair csock   = { 92, bg };
static const Cpair cexec   = { 91, bg };
static const Cpair cother  = { 90, bg };

static const Cpair cframe  = { 236, 236 };
static const Cpair cpanell = { 166, 236 };
static const Cpair cpanelr = { 5,   236 };
